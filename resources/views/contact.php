<div class="mt-10 sm:mt-0">
    <div class="md:grid md:gap-3 justify-center content-center">
        <div class="mt-5 md:col-span-2 md:mt-0 justify-center">
                    ...
                    <div class="bg-white px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-2 sm:col-span-3 lg:col-span-12">
                                <label for="body" class="block text-sm font-medium text-gray-700">Extra info</label>
                                <textarea name="body" type="text" id="body" autocomplete="body"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </textarea>
                            </div>
                        </div>
